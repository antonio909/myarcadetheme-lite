...
/**
 * Modelo de Lista
 * Este modelo retorna as postagens relacionadas como uma lista separada por virgulas.
 * Autor: Megatemas.com
*/
		...
		<div>
			<div class="gmcn-midl">
				...
				<div class="gm-text">
					...
					<div class="gm-titl">
						<a href="<?php the_permalink(); ?>" title="<?php printf( __('Jogar %s', 'myarcadetheme'), get_the_title() ); ?>"><?php the_title(); ?></a>
					</div>
